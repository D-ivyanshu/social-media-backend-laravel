<template>
    <div
        class="bg-white h-12 flex items-center px-4 border-b border-gray-400 shadow-md"
    >
        <div class="w-1/3">
            <div class="flex">
                <router-link to="/">
                ...
                <div class="ml-2 relative">
                    ...
                    <input
                        type="text"
                        name="search"
                        class="w-56 bg-gray-200 rounded-md pl-8 focus:outline-none h-8 focus:ring-transparent text-sm"
